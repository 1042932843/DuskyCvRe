package nbsix.com.duskycvre.Module.UserCenter;
...
import nbsix.com.duskycvre.QRCode.AwesomeQRCode;
import nbsix.com.duskycvre.R;
import nbsix.com.duskycvre.Utils.SystemBarHelper;
...
public class UserInfoActivity extends BaseActivity {
    ...
    public void InitAvatatrANDQR() {
        Glide.with(this).load(ApiConstants.Base_IMG_URL + "/homemaking/upload/1496140112123.jpg").apply(DuskyApp.optionsRoundedCircle).into(user_info_avatar_view);
        Glide.with(this).asBitmap().load(ApiConstants.Base_IMG_URL + "/homemaking/upload/1496140112123.jpg").into(new SimpleTarget<Bitmap>(300, 300) {
            @Override
