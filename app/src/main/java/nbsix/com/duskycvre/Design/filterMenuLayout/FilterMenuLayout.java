package nbsix.com.duskycvre.Design.filterMenuLayout;
...
public class FilterMenuLayout extends ViewGroup {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        drawable = new FilterMenuDrawable(ctx, Color.GRAY, collapsedRadius);
        menuBounds = new Rect();
    ...
    public void setExpandProgress(float progress) {
        ...
        primaryPaint.setAlpha(Math.min(80, (int) (progress * 255)));
