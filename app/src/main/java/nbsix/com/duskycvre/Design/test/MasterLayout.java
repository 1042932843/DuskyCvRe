...
public class MasterLayout extends FrameLayout implements OnClickListener {
	...
	private void initialise() {
		...
		buttonimage = new TintImageView(getContext());
		full_circle_image = new TintImageView(getContext());
		arc_image = new TintImageView(getContext());

		fillcircle = new TintImageView(getContext());
