 ...
 */
package nbsix.com.duskycvre.Design.imagecoverflow;
...
public class CoverFlowView<T extends CoverFlowAdapter> extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //draw the mid children
        drawChild(canvas, mid, mid, mid-offset);

        // draw the left children
        int startPos = mid - leftChild;
        if(mAdapter.curMode == mAdapter.MODE_MUTIL){
        ...
        if(mAdapter.curMode == mAdapter.MODE_MUTIL || mAdapter.curMode == mAdapter.MODE_DOUBLE){
